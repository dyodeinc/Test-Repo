...
$(document).ready(function(){
   ...
   $(".help-page-template ul._faq>ul>li").click(function(){

     var elem = jQuery(this);

     if(elem.hasClass("active")) {

       $(".help-page-template ul._faq li").each(function(){
         $(this).removeClass("active");
       });

       $(".help-page-template ul._faq>ul ul").each(function(){
   ...
   $(".help-page-template ul._faq>li").click(function(){

     var elem = jQuery(this);

     if(elem.hasClass("faq-active")) {

       $(".help-page-template .faq-active").each(function(){
         $(this).removeClass("faq-active");
       });

       $(".help-page-template .faq-panel").each(function(){
